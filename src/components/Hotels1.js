                ...
                <div class="col-lg">
                    ...
                    <Dropdown>
                        ...
                        <div id="hotels">
                                ...
                                <select id="hotels"onChange={e=>setHotels(e.target.value)}  required >
                                            <option value="0"><b>Select Hotels</b></option>
                                             <option value="Wish_4_Fish"><b>Wish 4 Fish</b></option>
                                            <option value="3_Star"><b>3star</b></option>
                                            <option value="one_8"><b>one 8</b></option>
                        ...
                        <div class="Breakfast">
                            ...
                            <input type="radio" id="Breakfast" name="breakfast" value="Yes"  class="custom-control-input" onChange={e=>setBreak(e.target.value)}/>
                        ...
                        <div class="lunch">
                            ...
                            <input type="radio" id="lunch" name="lunch" value="Yes"  class="custom-control-input" onChange={e=>setLunch(e.target.value)}/>
                        ...
                        <div class="Dinner">
                            ...
                            <input type="radio" id="Dinner" name="dinner"  value="Yes" class="custom-control-input" onChange={e=>setDinner(e.target.value)}/>
